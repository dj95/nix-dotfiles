...
material.setup({
  ...
  custom_highlights = {
    -- Common
    Cursor = { fg = colors.bg_alt, bg = colors.cyan },
    CursorIM = { fg = colors.bg_alt, bg = colors.cyan },
    ...
    Folded = { fg = colors.disabled, bg = colors.active, style = 'italic' }, -- line used for closed folds
    ...
    -- Dashboard
    DashboardShortCut =                     { fg = colors.comment },
    DashboardHeader =                       { fg = colors.green },
    DashboardCenter =                       { fg = colors.accent },

    -- Telescope
    TelescopeNormal =                       { fg = colors.fg, bg = '#090b16' },
    TelescopePromptBorder =                 { fg = colors.fg, bg = '#1E2233' },
    TelescopeResultsBorder =                { fg = colors.fg, bg = '#090b16' },
    TelescopePreviewBorder =                { fg = colors.fg, bg = '#090b16' },
    TelescopeSelectionCaret =               { fg = colors.green },
    TelescopeSelection =                    { fg = colors.green, bg = '#1E2233' },
